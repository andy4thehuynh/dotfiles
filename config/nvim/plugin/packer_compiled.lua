...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["vim-ruby"] = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/vim-ruby",
