...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  playground = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-fugitive"] = {
    loaded = true,
    path = "/Users/andyhuynh/.local/share/nvim/site/pack/packer/start/vim-fugitive",
